...
class Permission(Base):
    ...
    display_group_id = Column(Integer, ForeignKey("permission_display_group.id"), nullable=True)
...
class AccessGroupPermission(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    access_group_id = Column(Integer, ForeignKey("access_group.id"), nullable=False)
    permission_id = Column(Integer, ForeignKey("permission.id"), nullable=False)

    __table_args__ = (
        UniqueConstraint("access_group_id", "permission_id", name="uq_access_group_permission"),
    )
...
class RoleAccessGroup(Base):
    ...
    __table_args__ = (
        UniqueConstraint("role_id", "access_group_id", name="uq_role_access_group"),
    )
